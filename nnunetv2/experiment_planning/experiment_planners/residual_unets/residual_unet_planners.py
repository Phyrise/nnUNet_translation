...
from dynamic_network_architectures.architectures.unet import ResidualUNet
...
class nnUNetPlannerResUNet(ResUNetPlanner):
    """
    ...
    def __init__(self, dataset_name_or_id: Union[str, int],
        ...
        if gpu_memory_target_in_gb != 8:
            warnings.warn("WARNING: You are running nnUNetPlannerResUNet with a non-standard gpu_memory_target_in_gb. "
...
class nnUNetPlannerResUNetXL(ResUNetPlanner):
    """
